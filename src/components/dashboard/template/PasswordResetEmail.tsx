      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={contentSection}>
            ...
            <Text style={mainText}>
              Hi there! Forgot your password? No worries, we've got you covered. Use the code below to reset your password in GIW.
            </Text>
            <Section style={verificationSection}>
              <Text style={verifyText}>Your Verification Code</Text>
              <Text style={codeText}>{code}</Text>
              <Text style={validityText}>This code expires in {minutesUntilExpiry} minutes.</Text>
            </Section>
          </Section>
        </Container>
      </Body>
